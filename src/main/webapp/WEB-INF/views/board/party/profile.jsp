                    ...
                    <div class="col-10">
                        ...
                        <div class="tab-content" id="nav-tabContent">
                            ...
                            <div class="tab-pane fade" id="nav-owner" role="tabpanel" aria-labelledby="nav-owner-tab">
	                               ...
	                               <div class="row border">생성프로젝트 : ${proj.projTitle }</div>
	                               	<c:forEach var="waiterProj" items="${waiterProj}">
	                               		<c:if test="${proj.hierId eq waiterProj.hierId}">
		                                	<c:forEach var="waiter" items="${waiter}">
			                                	<div class="row"> 대기ID : ${ waiter.partyId } 
			                                	<form action="profile" method="post">
			                                	 		<input type="hidden" name="project" value="${proj.hierId}">
                            	...
                            	<div class="tab-pane fade" id="nav-member" role="tabpanel" aria-labelledby="nav-member-tab">
                                 <c:forEach var="proj" items="${projM}">
                                	 <div>참여중인 프로젝트 : ${proj.projTitle }</div>
                                 </c:forEach>
                           		 </div>
